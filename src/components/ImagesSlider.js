...
images: [
  ...
  details:{ 
   ...
   subHeading: '2 months',
   par: `
   A homeowner undertakes a bathroom renovation, opting for a mosaic tiling project. The design features vibrant blue and white ceramic tiles, artistically arranged to create a calming, ocean-inspired theme, enhancing the room's aesthetic and increasing the home's overall value.`
  }
},
...
return (
  ...
  <div className='slider-cont'>
      {data.map((item, index) => (
          <section className={`imgs-cont imgs-cont${index}`}   key={index}>
